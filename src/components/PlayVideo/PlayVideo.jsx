...
const PlayVideo = () => {
    ...
    const fetchOtherData = async() =>{
        ...
        //fetch comment data
        const comment_url=`https://youtube.googleapis.com/youtube/v3/commentThreads?part=snippet%2Creplies&,axResults=50&videoId=${videoId}&key=${API_KEY}`
  ...
  return (
    <div className='play-video'>
        ...
        <div className="play-video-info">
            ...
            <div>
                <span><img src={like} alt="" /> {apiData?value_converter(apiData.statistics.likeCount): 265}</span>
